...
public class Graph<T: Hashable> {
	...
	// Removes the edge between the given nodes. Returns nil if the edge doesn't exist.
	// Removes 
    @discardableResult
	...
	// Returns a random node from the graph, or nil if the graph does'nt contain any nodes
