...
let pars3 = Parameters(moral: (0.57244760994553034, 3.0), p: (0.25601780920923867, 1.5218269944202474), a: (0.0, 2.442246923716779), d: (-0.29552941686816603, 0.087866518722618636), baseGain: 0.10515379585305042, baseCost: 0.98761477219196092, edges: 6, edgeWeight: 7.9626005895711751, weightDec: 0.67906644252280945, maxDecExt: 1.2513836318339777, incGun: 0.32255865482422419)

//try! runSimulation(pars2, days: 365*10, g: loadGraph(from: URL(fileURLWithPath: "graph.txt")))
runSimulation(pars3, days: 365*5, population: 10_000)
/*
